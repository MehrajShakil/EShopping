...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(UserRegistrationRequest user)
        {
            if (user == null)
            {
                return BadRequest("User Not Found to create!");
            }

            var userCreatedresult = await accountService.CreateUserAsync(user);
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var loginResult = await accountService.UserLoginAsync(model);
